...
export const CHARACTERS: Record<string, CharacterConfig> = {
  '9527': {
    ...
    name: '牛马 9527',
    title: '资深社畜',
    description: '职场老油条，擅长带薪拉屎。每波开始时获得 20% 的存款利息。攻击时会按顺序吐出职场黑话。',
    emojiNormal: '😐',
    emojiHurt: '😰',
    emojiCritical: '😱',
    baseStats: {
        ...
        speed: 6,
        attackDamage: 15,
        attackSpeed: 33, // Reduced (25 / 0.75)
        projectilePierce: 0,
        projectileCount: 1,
  ...
  '007': {
    ...
    emojiNormal: '😎',
    emojiHurt: '🥴', // Changed from 😵‍💫 to avoid rendering issues
    emojiCritical: '🤯',
    baseStats: {
        maxHp: 80,
        speed: 7,
        attackDamage: 20,
        attackSpeed: 51, // Reduced (38 / 0.75)
        projectilePierce: 0, 
        projectileCount: 1,
  ...
  '1024': {
      ...
      name: '程序猿 1024',
      title: '脱发强者',
      description: '逻辑缜密但身体脆弱。自带 2 点穿透。攻击附带随机“特性(Bug)”代码，子弹大小和内容随机，有 15% 概率让敌人死机(眩晕)。',
      emojiNormal: '🤓',
      emojiHurt: '😵',
      emojiCritical: '🤕', // Changed from laptop to bandaged head
      baseStats: {
          maxHp: 60,
          speed: 6.5,
          attackDamage: 18,
          attackSpeed: 29, // Reduced (22 / 0.75)
          projectilePierce: 2,
          projectileCount: 1,
          incomeMultiplier: 1.0
      },
...
export const MENU_QUOTES = [
    ...
    "下班！", "周五了！", "不想上班", "救命", "SOS",
    "扣1送佛祖", "你人还怪好嘞", "这谁顶得住啊", "质疑理解成为", "更适合中国宝宝体质",
    "遥遥领先", "显眼包", "我没K", "恐龙抗狼", "想你的风", "尊嘟假嘟", "哈基米哈基米",
...
export const SHOP_ITEMS: UpgradeOption[] = [
  ...
  },
  {
    id: 'insurance',
    title: '意外险',
    description: '受到伤害时获得 10 块钱理赔金 (每份单局上限800，可叠加)。',
    rarity: 'rare',
    category: 'item',
    price: 180,
    icon: '📝',
  ...
  },
  {
    id: 'involution_king',
    title: '卷王之王',
    description: '全属性大幅提升，最大生命-10，每秒扣除 1点x数量 的生命值。',
    rarity: 'legendary',
    category: 'item',
    price: 350,
    icon: '👑',
  ...
  // Deflation Item
  {
    id: 'soft_landing',
    title: '经济软着陆',
    description: '降低 10% 的通货膨胀率（物价降低）。',
    rarity: 'legendary',
    category: 'item',
    price: 400,
    icon: '🛬',
    effect: (state) => {
        state.inflationRate = Math.max(0, state.inflationRate * 0.9);
